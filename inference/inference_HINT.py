...
from fewlens.archs.HINT_arch import *
import numpy as np
...
def main():
    ...
    parser.add_argument(
        ...
        '--weight',
        type=str,
        default='/home/ubuntu13/zsh/code/Aberration_Correction_MIPI-main/experiments/HINT_perturbed/models/net_g_latest.pth',
