...
from fewlens.archs.ASTv2_TLC_arch import *
import numpy as np
...
def main():
    ...
    parser.add_argument('-i',
                        '--input',
                        type=str,
                        default='/home/ubuntu13/Downloads/test/lq',
                        help='Input image or folder')
    parser.add_argument('-o',
                        '--output',
                        type=str,
                        default='results_multy',
                        help='results image folder')
    parser.add_argument(
        '-w',
        '--weight',
        type=str,
        default='/home/ubuntu13/zsh/code/Aberration_Correction_MIPI-main/experiments/AST/net_g_latest.pth',
    ...
    wb_param = np.load('/home/ubuntu13/Downloads/test/wb_params.npz')
