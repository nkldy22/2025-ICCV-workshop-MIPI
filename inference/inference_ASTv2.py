...
def main():
    ...
    parser.add_argument('-o',
                        '--output',
                        type=str,
                        default='results_MULTI_AST',
                        help='results image folder')
    parser.add_argument(
        '-w',
        '--weight',
        type=str,
        default='/home/ubuntu13/zsh/code/Aberration_Correction_MIPI-main/experiments/ASTv2_72_dim_perturbed/models/net_g_latest.pth',
