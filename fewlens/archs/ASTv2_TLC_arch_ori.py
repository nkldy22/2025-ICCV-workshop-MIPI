...
class ASTv2_ori(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        original_h, original_w = inp_img.shape[-2], inp_img.shape[-1]
        return out_dec_level1[:, :, :original_h, :original_w]
